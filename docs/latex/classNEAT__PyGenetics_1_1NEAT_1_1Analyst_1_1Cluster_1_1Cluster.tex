...
Attributes\+: cluster\+\_\+id (\+\_\+id)\+: The \hyperlink{classNEAT__PyGenetics_1_1NEAT_1_1Analyst_1_1Cluster_1_1Cluster}{Cluster}\textquotesingle{}s ID, unique representative\+: The ID of the representative Storage\+Genome. All genomes in the cluster are topologically similar to it\textquotesingle{}s representative genome. fitness\+: The cluster\textquotesingle{}s fitness value. This is calculated from the fitness values of the contained genomes by a shared fitness approach. offspring\+: The amount of offspring that will be generated based on genomes from this clusters during the next generation. alive\+: Whether the cluster is alive, i.\+e. if there are any genomes in the current population which belong to this cluster. 
