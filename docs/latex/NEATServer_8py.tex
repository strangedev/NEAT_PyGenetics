...
\begin{DoxyCompactList}\small\item\em A thread which operates on networking message queues via \hyperlink{namespaceNEAT__PyGenetics_1_1NEAT_1_1Networking_1_1Server_1_1JSONSocket}{J\+S\+O\+N\+Socket} in two different modes\+: \end{DoxyCompactList}\item 
