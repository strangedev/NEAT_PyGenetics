...
class GenomeAnalyst(object):
    ...
    def analyze(
        ...
        # later
        self._result.geneClosesCycleMap = copy.deepcopy(genome.edges)  # TODO: refactor AnalysisResult
        ...
        for source in self._result.cycle_nodes:
            ...
            for target in target_list:
                if target in self._result.geneClosesCycleMap[source]:  # TODO: refactor AnalysisResult
                    self._result.geneClosesCycleMap[source].remove(target)  # TODO: refactor AnalysisResult
