...
class GenomeAnalyst(object):
    ...
    def analyze(
        ...
        # later
        self._result.gene_closes_cycle_map = copy.deepcopy(genome.edges)  # TODO: refactor AnalysisResult
        ...
        for source in self._result.cycle_nodes:
            ...
            for target in target_list:
                if target in self._result.gene_closes_cycle_map[source]:  # TODO: refactor AnalysisResult
                    self._result.gene_closes_cycle_map[source].remove(target)  # TODO: refactor AnalysisResult
